...
const KycComplianceTab: React.FC<KycComplianceTabProps> = ({ customer, customerType }) => {
      ...
      <div className="bg-gray-50 dark:bg-dark-700 rounded-lg p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className={`inline-flex px-3 py-1 text-sm font-semibold rounded-full ${getKycStatusBadge(customer.kycStatus)}`}>
              {customer.kycStatus}
            </span>
          </div>
        </div>
        ...
        <div className="bg-gray-50 dark:bg-dark-700 rounded-lg p-6">
          ...
          <div className="mb-4">
            <div className="flex justify-between items-center">
              <span className="text-gray-600 dark:text-dark-400">ID Type:</span>
              <span className="font-medium text-gray-900 dark:text-dark-100">
                {personalCustomer.kycDocuments.idType.replace('_', ' ')}
              </span>
            </div>
          </div>
